-- sql/duckdb/chau_civic_event_clean.sql
-- ============================================================
-- PURPOSE
-- ============================================================
-- Completely removes civic_event tables from the DuckDB database (DuckDB).
...
-- In civic_event:
-- - attendance depends on civic_event (attendance has civic_event_id).
-- Therefore:
-- - Drop attendance first, then drop civic_event.
--
